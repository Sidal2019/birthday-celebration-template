    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Tanish</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Tanish's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p> You deserve the whole world, but for now, please accept this little love from me💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — Ashmi 💖</h2>
          <p className="final-subtitle">I Love You 💖✨</p>
        </section>
      </div>
